...
export function CardWrapper({ children, className = '' }: CardWrapperProps) {
  return (
    <div className={`max-w-7xl mx-auto rounded-[2rem] bg-surface-card/30 backdrop-blur-md border border-border-subtle p-8 md:p-12 relative overflow-hidden group shadow-lg ${className}`}>
