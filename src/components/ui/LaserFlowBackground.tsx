...
interface LaserFlowBackgroundProps {
  className?: string;
...
export const LaserFlowBackground = ({
  className,
  style,
  wispDensity = 1,
  dpr,
  ...
  useEffect(() => {
    ...
    if (!mount) {
      console.error('LaserFlow: mount ref is null');
      return;
    }
  ...
  useEffect(() => {
    ...
    const { r, g, b } = hexToRGB(color || '#8b5cf6');
