...
const education = [
  {
    ...
    location: 'Calgary, AB',
    status: 'In Progress',
    description: 'Comprehensive program combining computer science principles with business information systems, focusing on software development, database management, and system analysis.',
    highlights: [
  ...
  },
  {
    ...
    location: 'Calgary, AB',
    status: 'Completed',
    description: 'Intensive hands-on program focused on practical software development skills, including programming languages, database management, and web technologies.',
    highlights: [
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-muted max-w-3xl mx-auto">
            Continuous learning and academic excellence in computer science and information systems
          </p>
        </motion.div>
            ...
            >
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-mono text-accent2">{edu.period}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-muted">Location:</span>
                      <span className="text-foreground">{edu.location}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-muted">GPA:</span>
                      <span className="text-accent font-semibold">{edu.gpa}/4.0</span>
                    </div>
                    {edu.expectedGraduation && (
                      <div className="flex items-center justify-between">
                        <span className="text-muted">Expected:</span>
                        <span className="text-secondary">{edu.expectedGraduation}</span>
                      </div>
                    )}
                    {edu.certification && (
                      <div className="flex items-center justify-between">
                        <span className="text-muted">Achievement:</span>
                        <span className="text-accent font-semibold">{edu.certification}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                  <div>
                    <h4 className="text-lg font-semibold text-accent2 mb-3">{edu.degree}</h4>
